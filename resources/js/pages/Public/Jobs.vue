...
function sendViaWhatsApp() {
    ...
    if (!name.trim() || !phone.trim() || !position) {
        formError.value =
            'Por favor completa los campos obligatorios: Nombre, Teléfono y Vacante de interés.';
...
msg += `*Fecha de nacimiento:* ${formatDate(form.value.birthdate)}\n`;
}

    msg += `*Teléfono:* ${phone.trim()}\n`;

    if (form.value.email.trim()) {
msg += `*Correo:* ${form.value.email.trim()}\n`;
}

    msg += `*Vacante de interés:* ${position}\n`;

    if (form.value.availability) {
msg += `*Disponibilidad:* ${form.value.availability}\n`;
}
...
<template>
    <Head>
        ...
        <meta
            head-key="og:title"
            property="og:title"
            content="Bolsa de Trabajo — Tres Cantares"
        />
    ...
    <div class="tc-privacy-page tc-public-layout">
        ...
        <img
            ...
            style="
                ...
                top: 80px;
                width: clamp(180px, 18vw, 340px);
                animation: tc-float-med 9s 1s ease-in-out infinite;
            "
        />
        ...
        >
            <div class="tc-jobs-title-container">
                ...
                <h1 class="tc-page-title-xl">Bolsa de<br />Trabajo</h1>
        ...
        <!-- ── FORMULARIO ─────────────────────────────────── -->
        <section
            class="tc-jobs-form-section"
            style="position: relative; z-index: 30"
        >
            <div class="tc-jobs-inner">
                <!-- Intro -->
                <div class="tc-jobs-intro">
                    <p class="font-display tc-jobs-intro-title">
                        ¿Por qué trabajar con nosotros?
                    </p>
                    <p class="font-body tc-jobs-intro-text">
                        En Tres Cantares somos más que un restaurante. Somos un
                        equipo apasionado por la gastronomía mexicana,
                        comprometido con ofrecer la mejor experiencia en el
                        corazón de Tepoztlán. Postúlate y forma parte de esta
                        familia.
                    </p>
                </div>
                ...
                <div class="tc-jobs-form-card">
                    <div class="tc-jobs-form-header">
                        <p class="tc-jobs-form-eyebrow font-display">
                            ✦ ÚNETE A NUESTRO EQUIPO ✦
                        </p>
                        <h2 class="font-display tc-jobs-form-title">
                    ...
                    <form @submit.prevent="sendViaWhatsApp" novalidate>
                        <div class="tc-jobs-form-grid">
                            ...
                            <div class="tc-jobs-field tc-jobs-field--full">
                                <label
                                    class="tc-jobs-label font-body"
                                    for="j-name"
                                >
                                    Nombre completo
                                    <span style="color: var(--tc-pink)">*</span>
                                </label>
                                <input
                                    id="j-name"
                                    type="text"
                            ...
                            <div class="tc-jobs-field">
                                <label class="tc-jobs-label font-body"
                                    >Disponibilidad de horario</label
                                >
                                <TcSelect
                            ...
                            <div class="tc-jobs-field tc-jobs-field--full">
                                ...
                                <textarea
                                    ...
                                    placeholder="Cuéntanos sobre tu experiencia o por qué te interesa formar parte de Tres Cantares..."
                                ></textarea>
                            </div>
                        </div>

                        <p v-if="formError" class="tc-jobs-error font-body">
                            {{ formError }}
                        </p>

                        <p class="tc-jobs-disclaimer font-body">
                            Al enviar tu información por WhatsApp, aceptas que
                            Tres Cantares te contacte para el seguimiento de tu
                            solicitud.
                            <a
                                href="/aviso-de-privacidad"
                                class="tc-jobs-disclaimer-link"
                        ...
                        <div style="text-align: center">
                            <button
                                type="submit"
                                class="tc-jobs-submit-btn font-body"
                            >
                                <svg
                                    style="
                                        width: 24px;
                ...
                <p
                    class="font-body tc-jobs-cta-hint"
