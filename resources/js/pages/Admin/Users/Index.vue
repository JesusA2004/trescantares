...
function roleClass(role: string) {
    return roleColors[role] ?? 'tc-badge-gray';
}
...
<template>
    ...
    <div class="tc-admin-page space-y-5">
        ...
        <div class="tc-toolbar">
            ...
            <span
                v-if="filtered.length !== users.length"
                ...
                <tbody>
                    <template v-if="filtered.length > 0">
                        <tr v-for="user in filtered" :key="user.id">
                            ...
                            <td
                                class="hidden text-sm text-gray-600 sm:table-cell"
                            >
                                {{ user.email }}
                            </td>
                            <td>
                                <div class="flex flex-wrap gap-1">
                                    ...
                                    <span
                                        ...
                                        class="tc-badge tc-badge-gray"
                                        >Sin rol</span
                                    >
                                </div>
                            </td>
                            <td
                                class="hidden text-xs text-gray-400 tabular-nums md:table-cell"
                            >
                                {{ user.created_at }}
                            </td>
                            <td class="text-right">
