            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
                ...
                <div class="xl:col-span-1 space-y-4">
                    <div class="tc-admin-card p-5">
                        ...
                        />
                        <p class="text-xs text-gray-400 mt-2">Usa minúsculas y sin espacios. Ej: <code class="bg-amber-50 px-1 rounded text-amber-700">editor-menu</code></p>
                    </div>

                    <!-- Permissions summary -->
                    <div class="tc-admin-card p-5">
                        <div class="flex items-center justify-between mb-3">
                            <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide">Permisos seleccionados</p>
                        </div>
                ...
                <div class="xl:col-span-2 space-y-4">
                    ...
                    >
                        <!-- Group header -->
                        <div
                            class="px-5 py-3 border-b border-amber-100/60 flex items-center justify-between cursor-pointer bg-gradient-to-r from-amber-50/60 to-transparent"
