...
const form = useForm({
    ...
    // Menu
    menu_show_prices:
        props.settings.menu_show_prices === '1' ||
        props.settings.menu_show_prices === true,
    ...
    jobs_enabled:
        props.settings.jobs_enabled === '1' ||
        props.settings.jobs_enabled === true,
    // Images
...
<template>
    ...
    <div class="tc-admin-page space-y-5">
        <AdminPageHeader
            title="Configuración"
            description="Ajusta los datos y apariencia del sitio"
        >
        ...
        <form @submit.prevent="submit" class="space-y-4">
            ...
            <template v-if="activeTab === 'general'">
                <AdminFormSection title="Información del restaurante">
                    ...
                    <TcTextarea
                        ...
                        label="Horarios"
                        :rows="4"
                        placeholder="Lunes a Jueves: 9am–10pm&#10;Martes: cerrado"
                    />
                    <TcTextarea
                        id="maps_url"
                        ...
                        :rows="3"
                        hint="Copia el src del iframe de Google Maps"
                    />
                </AdminFormSection>
            </template>
            ...
            <template v-if="activeTab === 'branding'">
                <AdminFormSection
                    ...
                    description="Dejar sin cambios para conservar las imágenes actuales"
                >
            ...
            <template v-if="activeTab === 'urls'">
                <AdminFormSection
                    ...
                    description="Solo la URL de facturación es personalizable. Las demás son rutas fijas del sistema."
                >
                    <TcInput
                        id="billing_url"
                        v-model="form.billing_url"
                        label="Facturación URL"
                        placeholder="https://…"
                        hint="URL externa donde los clientes pueden solicitar factura"
                    />
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div class="tc-field">
                            ...
                            <div
                                class="tc-input flex cursor-default items-center gap-2 bg-gray-50 text-gray-500 select-text"
                            >
                                <span
                            ...
                            <p class="tc-help-text">
                                Ruta interna del sistema, no editable
                            </p>
                        </div>
                        <div class="tc-field">
