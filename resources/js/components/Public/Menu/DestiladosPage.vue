...
const groups = computed(() => [
    {
        key: 'tequila',
        title: 'Tequila',
        items: byZone(props.category.items, 'tequila'),
    },
    {
        key: 'mezcal',
        title: 'Mezcal',
        items: byZone(props.category.items, 'mezcal'),
    },
...
<template>
    ...
    >
            ...
            >
                <template v-if="group.items.length">
                    ...
                    <div
                        ...
                        :key="item.id"
                        class="tc-mp-spirit-row"
                    >
                        <span class="tc-mp-spirit-name">
                            {{ item.name }}
                            <span
                                v-if="item.presentation"
                                class="tc-mp-spirit-presentation"
        ...
        <div class="tc-mp-social-row">
            <a
                href="https://facebook.com/trescantares"
                target="_blank"
                rel="noopener"
                aria-label="Facebook"
            >
            ...
            <a
                href="https://instagram.com/trescantares"
                target="_blank"
                rel="noopener"
            ...
            <a
                href="https://tiktok.com/@trescantares"
                target="_blank"
                rel="noopener"
                aria-label="TikTok"
            >
