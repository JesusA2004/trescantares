        ...
        <div class="tc-mp-grid--comal">
            ...
            <div class="tc-mp-comal-hero">
                ...
                <div v-if="main" class="tc-mp-comal-name-block">
                    <p class="tc-mp-name tc-mp-name--lg" :style="{ color: category.color ?? undefined, '--tc-mp-h': category.color ?? undefined }">{{ main.name }}</p>
                    <p class="tc-mp-price tc-mp-price--md" :style="{ color: category.color_secondary ?? undefined }">${{ money(main.price) }}</p>
                </div>
            </div>

            <div v-if="fillings.length" class="tc-mp-options-grid tc-mp-comal-fillings">
                <div
            ...
            <div v-if="sope" class="tc-mp-alt-row tc-mp-comal-sope">
                ...
                <div class="tc-mp-alt-text">
                    <p class="tc-mp-name tc-mp-name--lg" :style="{ color: category.color ?? undefined, '--tc-mp-h': category.color ?? undefined }">{{ sope.name }}</p>
                    <p class="tc-mp-price tc-mp-price--md" :style="{ color: category.color_secondary ?? undefined }">${{ money(sope.price) }}</p>
                </div>
            </div>
        </div>
    </MenuPageFrame>
