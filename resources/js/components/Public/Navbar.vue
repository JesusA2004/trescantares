...
<template>
    <nav class="tc-public-navbar">
        ...
        <img
            :src="tornPaperSmall"
            class="tc-navbar-paper"
            alt=""
            decoding="async"
        />

        <!-- Desktop -->
        <div class="tc-navbar-inner hidden items-center lg:flex">
            <div class="tc-navbar-content">
                <div style="display: flex; align-items: center; gap: 44px">
                    ...
                    <Link
                        ...
                        class="tc-nav-link"
                        :class="{
                            'tc-nav-link-active': page.url === '/ubicacion',
                        }"
                        >Ubicación</Link
                    >
                </div>
                ...
                <div style="display: flex; align-items: center; gap: 44px">
                    ...
                    <a
                        :href="
                            settings.billing_url && settings.billing_url !== '#'
        ...
        <!-- Mobile -->
        <div class="tc-navbar-inner flex items-center lg:hidden">
            <div
                style="
                    width: 100%;
                    padding: 0 16px;
